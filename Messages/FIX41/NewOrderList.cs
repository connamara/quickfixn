...
public class NewOrderList : Message
{
    ...
    public void Set(ListNoOrds val) { ListNoOrds = val; }
    public ListNoOrds Get(ListNoOrds val) { GetField(val); return val; }
    public bool IsSet(ListNoOrds val) { return IsSetListNoOrds(); }
