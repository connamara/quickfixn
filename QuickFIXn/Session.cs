...
namespace QuickFix
{
    ...
    public class Session : IDisposable
    {
        ...
        protected void NextLogon(Message logon)
        {
            ...
            ulong msgSeqNum = logon.Header.GetSequence(Fields.Tags.MsgSeqNum);
        ...
        protected void NextResendRequest(Message resendReq)
        {
            ...
            try
            {
                ...
                {
                    ulong begSeqNo = resendReq.GetSequence(Fields.Tags.BeginSeqNo);
                    ulong endSeqNo = resendReq.GetSequence(Fields.Tags.EndSeqNo);
                    ...
                    if (!PersistMessages)
                    {
                        ...
                        msgSeqNum = resendReq.Header.GetSequence(Tags.MsgSeqNum);
                    ...
                    foreach (string msgStr in messages)
                    {
                        ...
                        msgSeqNum = msg.Header.GetSequence(Tags.MsgSeqNum);
        ...
        protected void NextSequenceReset(Message sequenceReset)
        {
            ...
            {
                ulong newSeqNo = sequenceReset.GetSequence(Fields.Tags.NewSeqNo);
        ...
        public bool Verify(Message msg, bool checkTooHigh, bool checkTooLow)
        {
            ...
            try
            {
                ...
                if (checkTooHigh || checkTooLow)
                    msgSeqNum = msg.Header.GetSequence(Fields.Tags.MsgSeqNum);
                ...
                if ((checkTooHigh || checkTooLow) && state_.ResendRequested())
                {
                    ...
                    else if (msgSeqNum >= range.ChunkEndSeqNo)
                    {
                        ...
                        ulong newChunkEndSeqNo = Math.Min(range.EndSeqNo, range.ChunkEndSeqNo + Convert.ToUInt64(this.MaxMessagesInResendRequest));
        ...
        protected void GenerateBusinessMessageReject(Message message, int err, int field)
        {
            ...
            ulong msgSeqNum = message.Header.GetSequence(Tags.MsgSeqNum);
        ...
        protected bool GenerateResendRequest(string beginString, ulong msgSeqNum)
        {
            ...
            {
                endChunkSeqNum = Math.Min(endRangeSeqNum, beginSeqNum + Convert.ToUInt64(this.MaxMessagesInResendRequest) - 1);
            }
            else
            {
        ...
        protected bool GenerateLogon(Message otherLogon)
        {
            ...
            if (this.EnableLastMsgSeqNumProcessed)
                logon.Header.SetField(new Fields.LastMsgSeqNumProcessed(otherLogon.Header.GetSequence(Tags.MsgSeqNum)));
        ...
        private bool GenerateLogout(Message other, string text)
        {
            ...
            if (other != null && this.EnableLastMsgSeqNumProcessed)
            {
                try
                {
                    logout.Header.SetField(new Fields.LastMsgSeqNumProcessed(other.Header.GetSequence(Tags.MsgSeqNum)));
                }
        ...
        public bool GenerateHeartbeat(Message testRequest)
        {
            ...
            try
            {
                ...
                if (this.EnableLastMsgSeqNumProcessed)
                {
                    heartbeat.Header.SetField(new Fields.LastMsgSeqNumProcessed(testRequest.Header.GetSequence(Tags.MsgSeqNum)));
                }
            }
            catch (FieldNotFoundException)
            { }
        ...
        public bool GenerateReject(Message message, FixValues.SessionRejectReason reason, int field)
        {
            ...
            if (message.Header.IsSetField(Fields.Tags.MsgSeqNum))
            {
                try
                {
                    msgSeqNum = message.Header.GetSequence(Fields.Tags.MsgSeqNum);
        ...
        protected void Persist(Message message, string messageString)
        {
            ...
            {
                ulong msgSeqNum = message.Header.GetSequence(Fields.Tags.MsgSeqNum);
        ...
        private void GenerateSequenceReset(Message receivedMessage, ulong beginSeqNo, ulong endSeqNo)
        {
            ...
            if (receivedMessage != null && this.EnableLastMsgSeqNumProcessed)
            {
                try
                {
                    sequenceReset.Header.SetField(new Fields.LastMsgSeqNumProcessed(receivedMessage.Header.GetSequence(Tags.MsgSeqNum)));
                }
                catch (FieldNotFoundException)
                {
