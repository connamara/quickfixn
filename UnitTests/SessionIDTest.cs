...
namespace UnitTests
{
    ...
    public class SessionIDTest
    {
        ...
        {
            SessionID sessionID = SessionID.FromString("FIX.4.2:SENDER->TARGET");
            Assert.That(sessionID.BeginString, Is.EqualTo("FIX.4.2"));
            Assert.That(sessionID.SenderCompID, Is.EqualTo("SENDER"));
            Assert.That(sessionID.TargetCompID, Is.EqualTo("TARGET"));
            Assert.That(sessionID.ToString(), Is.EqualTo("FIX.4.2:SENDER->TARGET"));

            sessionID = SessionID.FromString("FIX.4.2:SENDER->TARGET:QUALIFIER");
            Assert.That(sessionID.BeginString, Is.EqualTo("FIX.4.2"));
            Assert.That(sessionID.SenderCompID, Is.EqualTo("SENDER"));
            Assert.That(sessionID.TargetCompID, Is.EqualTo("TARGET"));
            Assert.That(sessionID.SessionQualifier, Is.EqualTo("QUALIFIER"));
            ...
            sessionID = SessionID.FromString("FIX.4.2:SENDER/SENDERSUB->TARGET/TARGETSUB");
            Assert.That(sessionID.BeginString, Is.EqualTo("FIX.4.2"));
            Assert.That(sessionID.SenderCompID, Is.EqualTo("SENDER"));
            Assert.That(sessionID.TargetCompID, Is.EqualTo("TARGET"));
            Assert.That(sessionID.TargetSubID, Is.EqualTo("TARGETSUB"));
            ...
            sessionID = SessionID.FromString("FIX.4.2:SENDER/SENDERSUB/SENDERLOC->TARGET/TARGETSUB/TARGETLOC");
            Assert.That(sessionID.BeginString, Is.EqualTo("FIX.4.2"));
            Assert.That(sessionID.SenderCompID, Is.EqualTo("SENDER"));
            Assert.That(sessionID.TargetCompID, Is.EqualTo("TARGET"));
            Assert.That(sessionID.TargetSubID, Is.EqualTo("TARGETSUB"));
            ...
            sessionID = SessionID.FromString("FIX.4.2:SENDER/SENDERSUB/SENDERLOC->TARGET/TARGETSUB/TARGETLOC:QUALIFIER");
            Assert.That(sessionID.BeginString, Is.EqualTo("FIX.4.2"));
            Assert.That(sessionID.SenderCompID, Is.EqualTo("SENDER"));
            Assert.That(sessionID.TargetCompID, Is.EqualTo("TARGET"));
            Assert.That(sessionID.SessionQualifier, Is.EqualTo("QUALIFIER"));
