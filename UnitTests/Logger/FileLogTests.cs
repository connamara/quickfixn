...
public class FileLogTests
{
    ...
    public void TestPrefix()
    {
        ...
        Assert.AreEqual("FIX.4.4-sender-target", FileLogger.Prefix(someSessionId));
        Assert.AreEqual("FIX.4.3-sender-target-foo", FileLogger.Prefix(someSessionIdWithQualifier));
    }
