...
namespace UnitTests
{
    public class ParserTest
    {
        ...
        public void ReadPartialFixMessage()
        {
            ...
            Assert.Equal(partFixMsg1 + partFixMsg2, readPartFixMsg);
        }
        ...
        public void ReadFixMessageWithBadLength()
        {
            ...
            parser.ReadFixMessage(out readFixMsg);
        }
