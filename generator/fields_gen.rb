...
class FieldGen
  def self.generate fixver, fields, fields_path, tags, tags_path
    fields.map! {|fld| fld.merge! type_info(fld) }
    File.open(fields_path, 'w') {|f| f.puts fields_str(fixver, fields) }
    File.open(tags_path, 'w') {|f| f.puts tags_str(fixver, tags) }
  end
  ...
  def self.fields_str fixver, fields
<<HERE
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace QuickFix.#{fixver}.Fields
{
#{
    fields.map{|f|
...
HERE
  ...
  def self.tags_str fixver, fields
<<HERE
using System;
